...
fromFileName = "ALL_BE_51vars_calendar_O3_O3-7_19900101To20181231"
fromFileName = "df_no_TN_remove_low_risk_lag4_test_data"
ts = pd.read_csv("../data/{}.csv".format(fromFileName))
# toFileName = fromFileName

metric = "O3"
metric = "df_no_TN_remove_low_risk_lag4_test_data"
...
if metric == "PM10":
    ...
    # TODO: ALL Background-Rural ozone for 2019:
    ts2a = ts[['O3_BETN016', 'O3_BETN027', 'O3_BETN040', 'O3_BETN046', 'O3_BETN054', 'O3_BETN060', 'O3_BETN063',
               'O3_BETN066', 'O3_BETN073', 'O3_BETN085', 'O3_BETN093', 'O3_BETN100', 'O3_BETN113', 'O3_BETN121',
               'O3_BETN132', 'O3_BETN012', 'O3_BETN029', 'O3_BETN051']]
    ...
    # TODO: ALL Background-Rural ozone for 2019:
    ts2b = ts[['O3_BETN016-1', 'O3_BETN027-1', 'O3_BETN040-1', 'O3_BETN046-1', 'O3_BETN054-1', 'O3_BETN060-1',
               'O3_BETN063-1', 'O3_BETN066-1', 'O3_BETN073-1', 'O3_BETN085-1', 'O3_BETN093-1', 'O3_BETN100-1',
               'O3_BETN113-1', 'O3_BETN121-1', 'O3_BETN132-1', 'O3_BETN012-1', 'O3_BETN029-1', 'O3_BETN051-1']]
...
elif metric == "df_no_TN_remove_low_risk_lag4_test_data":

    toFileName = "df_no_TN_remove_low_risk_lag4_test_data"
    ts.pop("event_id")
    # ts.to_csv("../data/{}.csv".format(toFileName), sep=',')
